document.addEventListener('DOMContentLoaded', () => {
    ...
    // Apunta al backend en producción dentro de Hugging Face
    ...
    // Función auxiliar para renderizar los Markdown básicos de Gemini en la interfaz
    ...
    async function sendMessage() {
        ...
        try {
            ...
            if(response.ok) {
                ...
                appendMessage(`Error: ${data.detail}`, 'system-msg', false);
            }
        } catch (error) {
